      ...
      <div className="container">
        <div className="project-heading">
          <div>
            ...
            <h2 className="section-title v11-title rv rv-d1" aria-label="Engineering projects and outcomes.">
        ...
        <div className="case-list">
          {projects.map((project, index) => (
            <article className={`case-study ${index % 2 ? "reverse" : ""}`} key={project.name} data-project-index={`0${index + 1}`}>
              ...
              <div className="case-visual-shell rv">
                <div className={`case-visual ${index === 0 ? "terminal-visual" : "globe-visual"}`} aria-hidden="true">
